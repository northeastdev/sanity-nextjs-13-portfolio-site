...
export default function SectionTitleDescription({
  ...
  return (
    <div className=" space-y-1 text-black-secondary px-4 md:px-6 lg:px-8 dark:text-white-primary">
      <h2 className="md:w-96 py-2 text-4xl md:text-5xl font-bai font-extrabold bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-transparent bg-clip-text">
        {title}
      </h2>
